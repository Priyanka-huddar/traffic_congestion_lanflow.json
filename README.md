...
- Early detection of congestion risks using trend and deviation analysis
- Generation of explainable alerts and planning-level recommendations
- Use of RAG to align advisories with standard congestion management and transportation planning guidelines
...
- Incorporates external factors such as weather conditions and incidents
- Uses IBM Granite LLM for semantic pattern understanding

### 2. Congestion Risk Detection Agent
- Compares real-time traffic data with historical and seasonal trends
- Detects early signs of congestion buildup
- Flags potential hotspots before they become critical

### 3. Alert & Planning Assistant (Assistive Only)
- Issues early warning alerts to traffic authorities
- Provides planning-level advisories such as rerouting suggestions or signal timing recommendations
- Operates with a human-in-the-loop approach (no automated control)
...
- **Traffic Data Sources** – Historical traffic data, real-time feeds, weather and incident reports  
...
- Context-aware congestion prediction using external factors
- Assistive decision support for traffic authorities
...
- Road and Highway Maintenance Agencies
- Emergency Services
...
- Integration with navigation and public information systems
- Emergency vehicle route prioritization
- Support for long-term urban traffic planning
